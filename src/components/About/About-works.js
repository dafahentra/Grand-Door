...
export default function AboutWorks() {
  ...
  return (
    <section id="about" className="about-section" data-scroll-section>
      <div className="font-white ml-1 tablet-m-0 title title-description"  data-scroll data-scroll-direction="vertical" data-scroll-speed="2">SEBUAH INOVASI HOROR YANG MENGGABUNGKAN ELEMEN RUMAH HANTU KLASIK DENGAN TANTANGAN ESCAPE GAME. KAMI MENCIPTAKAN PENGALAMAN HOROR BARU DAN MEMIKAT BAGI PARA PECINTA PETUALANG</div>
