...
export default function AboutInstagram() {
  return (
    <section id="about-instagram" className="about-instaram-section" data-scroll-section>
      ...
      <div className="font-neutral ml-5 mt-24 tablet-ml-0 text" data-scroll data-scroll-direction="vertical" data-scroll-speed="1">Dont Forget<br></br>To Follow Us! &#8594; <a className="font-white hover-underline-animation" href="https://www.instagram.com/granddoor.id/" target="_blank" rel="noreferrer">{/* Instagram redirection link */}HERE</a></div>
    </section>
  )
}